...
function Petal() {
  return (
    ...
    >
      <path
        d="M7 20C1.00001 15.1111 -0.4 8.6 1.19999 4.6C2.79999 0.6 7 0 7 0C7 0 11.2 0.6 12.8 4.6C14.4 8.6 13 15.1111 7 20Z"
        fill="currentColor"
      />
      <path
        d="M7 20C7.8 17.2 8.5 12.4 7.8 9.2C7.1 6 7 0 7 0"
...
export function PetalDrift({
  ...
  useEffect(() => {
    const generatedPetals = Array.from({ length: quantity }, () => ({
      ...
      top: `${Math.random() * -100}vh`, // random starting Y position above viewport
